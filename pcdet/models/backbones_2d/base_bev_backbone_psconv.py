...
from  pcdet.models.psconv.psconv import PSConv
...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = PSConv(c1=inplanes, c2=planes, k=3, s=stride)
        self.bn1 = nn.BatchNorm2d(planes, eps=1e-3, momentum=0.01)
        self.relu1 = nn.ReLU()
        # self.conv2 = nn.Conv2d(planes, planes, kernel_size=3, padding=1, bias=False)
        self.conv2 = PSConv(c1=planes, c2=planes, k=3, s=1)
